...
// import EditProfileModal from '../Profile/EditProfileModal'; // Adjust path
...
//         {/* Pass the edit function to SidebarMenu */}
//         <SidebarMenu onEditProfile={profile ? openEdit : null} />
...
//       {/* Edit Profile Modal - Now rendered outside sidebar using Portal */}
//       {isEditOpen && profile && (
//         <EditProfileModal
//           currentUser={profile}
//           onClose={closeEdit}
